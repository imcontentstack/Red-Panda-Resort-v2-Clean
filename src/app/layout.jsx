...
import WeatherEnrichment from '@/components/WeatherEnrichment';
...
const playfair_display = Playfair_Display({ subsets: ["latin"], variable: "--font-playfair", weight: ["400","500","600","700","800","900"] });
...
const open_sans = Open_Sans({ subsets: ["latin"], variable: "--font-opensans", weight: ["300","400","500","600","700","800"] });
const spectral = Spectral({ subsets: ["latin"], variable: "--font-spectral", weight: ["200","300","400","500","600","700","800"] });
const rokkitt = Rokkitt({ subsets: ["latin"], variable: "--font-rokkitt", weight: ["100","200","300","400","500","600","700","800","900"] });
const cormorant = Cormorant({ subsets: ["latin"], variable: "--font-cormorant", weight: ["300","400","500","600","700"] });
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.redpandaresort.com/images/logo.png" }],
  },
};
...
export default async function RootLayout({ children, params }) {
  ...
  return (
    <html lang={locale}>
      <Script src="https://kit.fontawesome.com/d480817398.js" crossOrigin="anonymous" />
      <style precedence="default" href="dynamic-font-rules">{`
      ...
      <body
        ...
        className={[
          inter.variable, poppins.variable, cinzel.variable, montserrat.variable,
          playfair_display.variable, roboto.variable, raleway.variable,
          open_sans.variable, spectral.variable, rokkitt.variable, cormorant.variable,
        ].join(" ")}
      >
        {process.env.LYTICS_TAG && <LyticsTracking />}
        {process.env.LYTICS_TAG && <WeatherEnrichment />}
        <AppWrapper>
          {children}
        </AppWrapper>
      </body>
